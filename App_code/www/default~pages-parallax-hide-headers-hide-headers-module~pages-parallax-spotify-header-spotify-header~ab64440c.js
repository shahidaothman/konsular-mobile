(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-parallax-hide-headers-hide-headers-module~pages-parallax-spotify-header-spotify-header~ab64440c"],{
...
var HidenavContentDirective = /** @class */ (function () {
    ...
    HidenavContentDirective.prototype.ngAfterViewInit = function () {
        var _this = this;
        if (!this.contentElem.nativeElement.hasAttribute('hidenav-tabspage')) {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_4___default()('[hidenav-header]', jquery__WEBPACK_IMPORTED_MODULE_4___default()(this.contentElem.nativeElement).parents().get().find(function (itm) { return jquery__WEBPACK_IMPORTED_MODULE_4___default()(itm).find('[hidenav-header]').length; })).attr('hidenav-header', this.name);
            this.start();
        }
        else {
            var counter_1 = 0;
    ...
    HidenavContentDirective.prototype.start = function () {
        if (this.name) {
    ...
    HidenavContentDirective.prototype.ngOnDestroy = function () {
        if (this.name) {
...
var HidenavHeaderDirective = /** @class */ (function () {
    ...
    HidenavHeaderDirective.prototype.ngAfterViewInit = function () {
        var _this = this;
    ...
    HidenavHeaderDirective.prototype.start = function () {
        if (this.name) {
            if (typeof this.globals.data[this.name] == 'undefined' || this.globals.data[this.name] == null)
                this.globals.data[this.name] = [];
    ...
    HidenavHeaderDirective.prototype.ngOnDestroy = function () {
        if (this.name) {
...
var HidenavService = /** @class */ (function () {
    ...
    HidenavService.prototype.requestName = function () {
        var name = 'page' + this.names.length;
        this.names.push(name);
        return name;
    };
    HidenavService.prototype.requestTabName = function (name) {
    ...
    HidenavService.prototype.initiate = function (name) {
        var names = [];
    ...
    HidenavService.prototype.initiate2 = function (name) {
        var _this = this;
        ...
        if (!parent) {
            ...
            contentElem.nativeElement.addEventListener('touchstart', function () { return _this.data[name].tapping = true; });
        }
        else if (parent) {
    ...
    HidenavService.prototype.c = function (name) {
    ...
    HidenavService.prototype.resetTabs = function (parent, name) {
        var _this = this;
...
var HidenavShContentDirective = /** @class */ (function () {
    ...
    HidenavShContentDirective.prototype.ngAfterViewInit = function () {
        var _this = this;
        if (!this.contentElem.nativeElement.hasAttribute('hidenav-tabspage')) {
            this.name = this.globals.requestName();
            jquery__WEBPACK_IMPORTED_MODULE_4___default()(this.contentElem.nativeElement).attr('hidenav-sh-content', this.name);
            jquery__WEBPACK_IMPORTED_MODULE_4___default()('hidenav-stretchheader', jquery__WEBPACK_IMPORTED_MODULE_4___default()(this.contentElem.nativeElement).parents().get().find(function (itm) { return jquery__WEBPACK_IMPORTED_MODULE_4___default()(itm).find('[hidenav-header]').length; })).attr('hidenav-sh-header', this.name);
            this.start();
        }
        else {
            var counter_1 = 0;
            var int_1 = setInterval(function () {
                var x = jquery__WEBPACK_IMPORTED_MODULE_4___default()(_this.contentElem.nativeElement).closest('[hidenav-sh-tabscontent]').attr('hidenav-sh-tabscontent');
                counter_1++;
                if (x && x.length > 0) {
                    _this.parent = jquery__WEBPACK_IMPORTED_MODULE_4___default()(_this.contentElem.nativeElement).closest('[hidenav-sh-tabscontent]').attr('hidenav-sh-tabscontent');
                    _this.name = _this.globals.requestTabName(_this.parent);
                    jquery__WEBPACK_IMPORTED_MODULE_4___default()(_this.contentElem.nativeElement).attr('hidenav-sh-content', _this.name);
                    jquery__WEBPACK_IMPORTED_MODULE_4___default()(_this.contentElem.nativeElement).attr('hidenav-tabspage', _this.parent);
                    _this.start();
                    clearInterval(int_1);
                }
    ...
    HidenavShContentDirective.prototype.start = function () {
        if (this.name) {
            if (typeof this.globals.data[this.name] == 'undefined' || this.globals.data[this.name] == null)
                this.globals.data[this.name] = [];
            this.globals.data[this.name].content = this.el;
    ...
    HidenavShContentDirective.prototype.ngOnDestroy = function () {
        if (this.name) {
            delete this.globals.data[this.name].content;
        }
    };
...
var HidenavShService = /** @class */ (function () {
    ...
    HidenavShService.prototype.requestName = function () {
        var name = 'page' + this.names.length;
        this.names.push(name);
        return name;
    };
    HidenavShService.prototype.requestTabName = function (name) {
        if (!this.tabnames[name])
            this.tabnames[name] = [];
        var tabname = name + 'tab' + this.tabnames[name].length;
        this.tabnames[name].push(tabname);
    ...
    HidenavShService.prototype.initiate = function (name) {
        var names = [];
        for (var key in this.data) {
            if (this.data[key].parent == name)
                names.push(key);
    ...
    HidenavShService.prototype.initiate2 = function (name) {
    ...
    HidenavShService.prototype.waitforelem = function (name, evaluate, func) {
        var x = eval(evaluate);
    ...
    HidenavShService.prototype.waitforelemTabs = function (name, evaluate, evaluate2, func) {
        var x = eval(evaluate);
    ...
    HidenavShService.prototype.proceedShrinkExpand = function (name) {
        var _this = this;
        ...
        this.data[name].content.getScrollElement().then(function (res) {
            ...
            _this.data[name].content.scrollByPoint(0, scrollDist, 0).then(function () {
                ...
                _this.data[name].content.ionScroll.subscribe(function (e) {
                    if (e.detail.scrollTop == 0) {
                    ...
                    if (_this.data[name].initExpanded) {
                        _this.data[name].content.scrollToPoint(0, 0, 0).then(function () {
                    ...
                    overlay.style.setProperty('--opacity', _this.data[name].opacityFactor / 10 * Math.min(e.detail.scrollTop / (_this.data[name].shrinkexpandHeight / 2), 1));
                    //event emitter
                    setTimeout(function () {
                ...
                //catch the last tick
                _this.data[name].content.ionScrollEnd.subscribe(function () {
                    setTimeout(function () {
    ...
    HidenavShService.prototype.proceedShrinkExpandTabs = function (name) {
        var _this = this;
        var parent = this.data[name].parent;
    ...
    HidenavShService.prototype.resetContent = function (name) {
    ...
    HidenavShService.prototype.findCurrentTab = function (parent) {
    ...
    HidenavShService.prototype.expand = function (parent, duration) {
    ...
    HidenavShService.prototype.shrink = function (parent, duration) {
        if (duration === void 0) { duration = 200; }
    ...
    HidenavShService.prototype.toggle = function (parent, duration) {
        if (duration === void 0) { duration = 200; }
        if (this.data[parent].content) {
            var height = parseInt(this.data[parent].header.nativeElement.parentNode.style.height, 10);
...
var HidenavStretchheaderComponent = /** @class */ (function () {
    ...
    HidenavStretchheaderComponent.prototype.ngOnInit = function () {
    };
    HidenavStretchheaderComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        var observer = new MutationObserver(function (mutations) {
            mutations.forEach(function () {
    ...
    HidenavStretchheaderComponent.prototype.start = function () {
        var _this = this;
        if (this.name) {
            if (typeof this.globals.data[this.name] == 'undefined' || this.globals.data[this.name] == null)
                this.globals.data[this.name] = [];
    ...
    HidenavStretchheaderComponent.prototype.expand = function (duration) {
        if (duration === void 0) { duration = 200; }
        this.globals.expand(this.name, duration);
    };
    HidenavStretchheaderComponent.prototype.shrink = function (duration) {
        if (duration === void 0) { duration = 200; }
        this.globals.shrink(this.name, duration);
    };
    HidenavStretchheaderComponent.prototype.toggle = function (duration) {
        if (duration === void 0) { duration = 200; }
        this.globals.toggle(this.name, duration);
    };
    HidenavStretchheaderComponent.prototype.ngOnDestroy = function () {
        if (this.name) {
            delete this.globals.data[this.name].header;
        }
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ContentChild"])('shrinkexpand', { read: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"] }),
...
//# sourceMappingURL=default~pages-parallax-hide-headers-hide-headers-module~pages-parallax-spotify-header-spotify-header~ab64440c.js.map